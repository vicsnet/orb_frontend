    ...
    <section className='relative bottom-0'>
      ...
      <div className="text-white absolute top-[98px] w-[90%] ml-[5%]">
        {/* landing page section */}
        {
          pathname === '/' ?
            <div className="">
              <h2 className="text-center text-[44px] font-bold leading-[52.8px] -tracking-[0.5px] mobile:text-[32px] mobile:leading-[40px]">Want to create your Orb</h2>
              <p className="text-[16px] font-bold leading-[22px] tracking-[0.15px] text-center mt-2 mobile:text-[14px] mobile:leading-[20px]">The future of creative independence. Create your first orb in seconds</p>
